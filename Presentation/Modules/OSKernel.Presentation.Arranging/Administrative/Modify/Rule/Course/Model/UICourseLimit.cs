...
namespace OSKernel.Presentation.Arranging.Administrative.Modify.Rule.Course.Model
{
    ...
    public class UICourseLimit : UIRuleBase
    {
        ...
        public List<XYKernel.OS.Common.Models.Administrative.Rule.PeriodLimit> PeriodLimits { get; set; }

        public UICourseLimit()
        {
            this.PeriodLimits = new List<XYKernel.OS.Common.Models.Administrative.Rule.PeriodLimit>();
        }
    }
}
