...
namespace OSKernel.Presentation.Arranging.Administrative.Modify.Rule.Teacher
{
    public class TeacherTimeViewModel : CommonViewModel, IInitilize
    {
        ...
        private List<XYKernel.OS.Common.Models.Administrative.Rule.TeacherTimeRule> _teacherTimes;
        ...
        {
            this.Comments = CommonDataManager.GetAdminRuleComments(AdministrativeRuleEnum.TeacherTime);
