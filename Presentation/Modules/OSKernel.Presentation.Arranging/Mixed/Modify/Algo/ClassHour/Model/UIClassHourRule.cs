...
namespace OSKernel.Presentation.Arranging.Mixed.Modify.Algo.ClassHour.Model
{
    public class UIClassHourRule : UIAlgoBase
    {
        ...
        /// 最大最小天数显示字段
        /// </summary>
        private string _maxAndMinDayString;
        public string MaxAndMinDayString
        {
            get
            {
                return _maxAndMinDayString;
            }

            set
            {
                _maxAndMinDayString = value;
                RaisePropertyChanged(() => MaxAndMinDayString);
            }
        }
