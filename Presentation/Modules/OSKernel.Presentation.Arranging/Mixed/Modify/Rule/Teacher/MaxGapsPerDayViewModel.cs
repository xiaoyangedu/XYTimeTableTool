...
namespace OSKernel.Presentation.Arranging.Mixed.Modify.Rule.Teacher
{
    public class MaxGapsPerDayViewModel : CommonViewModel, IInitilize
    {
        ...
        public void Initilize()
        {
            ...
            this.Comments = CommonDataManager.GetMixedRuleComments(MixedRuleEnum.TeacherMaxGapsPerDay);
        ...
        void save(HostView host)
        {
            ...
            {
                var gapsRule = new XYKernel.OS.Common.Models.Mixed.Rule.TeacherMaxGapsPerDayRule()
                {
